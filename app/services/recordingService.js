...
if (bucket && accessKeyId && secretAccessKey) {
  ...
  console.log(`✅ RecordingService S3 Client configured: Bucket=${bucket}, Region=${region}`);
} else {
  console.error('⚠️ RecordingService: S3 NOT configured! Videos will fail to upload.');
}
